...
<style>
    ...
    .card-content p {
        color: #626262;
                ...
                fs_2.default.writeFileSync(path_2.default.join(__dirname, "..", "public", "index.html"), htmlContent);
            }
        };
        this.clearSessionAndRestart = () => {
                ...
                func: ({ messages, type }) => {
                    ...
                    if ((_h = messageCtx.message) === null || _h === void 0 ? void 0 : _h.locationMessage) {
                        ...
                        if (typeof degreesLatitude === "number" &&
                            ...
                            payload = {
                                ...payload,
                                body: utils_1.default.generateRefprovider("_event_location_"),
                                type: "location",
                            };
                        }
                    }
                    ...
                    if ((_j = messageCtx.message) === null || _j === void 0 ? void 0 : _j.imageMessage) {
                        payload = {
                            ...payload,
                            body: utils_1.default.generateRefprovider("_event_media_"),
                            type: "image",
                        };
                    }
                    // Detect  ectar file
                    if ((_k = messageCtx.message) === null || _k === void 0 ? void 0 : _k.documentMessage) {
                        payload = {
                            ...payload,
                            body: utils_1.default.generateRefprovider("_event_document_"),
                            type: "file",
                        };
                    }
                    // Detect voice note
                    if ((_l = messageCtx.message) === null || _l === void 0 ? void 0 : _l.audioMessage) {
                        payload = {
                            ...payload,
                            body: utils_1.default.generateRefprovider("_event_voice_note_"),
                            type: "voice",
                        };
                    }
         ...
         */
        this.sendButtons = async (number, text, footer = "", buttons) => {
            const numberClean = utils_1.default.formatPhone(number);
